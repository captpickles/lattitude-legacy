...
pub fn sanserif() -> Result<FontRef<'static>, anyhow::Error> {
    Ok(FontRef::try_from_slice( include_bytes!("../../fonts/Comfortaa-Regular.ttf") )?)
}

pub fn sanserif_bold() -> Result<FontRef<'static>, anyhow::Error> {
    Ok(FontRef::try_from_slice( include_bytes!("../../fonts/Comfortaa-Bold.ttf") )?)
}

pub fn script() -> Result<FontRef<'static>, anyhow::Error> {
    Ok(FontRef::try_from_slice( include_bytes!("../../fonts/HoneyBlackDEMO.otf") )?)
}
